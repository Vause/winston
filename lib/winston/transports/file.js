...
const getMostRecentFile = require('./get-most-recent-file');
...
module.exports = class File extends TransportStream {
  ...
  constructor(options = {}) {
    ...
    this._maxFilesAndMaxSizeSpecified = options.maxsize && options.maxFiles;

    if (this.dirname) this._createLogDirIfNotExist(this.dirname);
    this._created = this._maxFilesAndMaxSizeSpecified ? getMostRecentFile(this.dirname, this._basename) : 0;
